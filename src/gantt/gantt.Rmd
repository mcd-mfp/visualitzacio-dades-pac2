...
## <font color="darkblue">Tècnica de visualització: Gantt</font>
...
legend(x=0.75, y=0.9, pch=22, pt.cex=2, cex=1.5, pt.bg=c("lightgreen","lightgrey"),
     border="black", legend=c("Entrega finalitzada", "Entrega no finalitzada"), bg="white", xpd=TRUE)
